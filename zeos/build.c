...
int main(int argc, char ** argv)
{
	...
	fprintf (stderr, "System     %7d Bytes (%3d kB)\n", sz, sz/1024);
	while (sz > 0) {
		int l, n;
	...
	fprintf (stderr, "User       %7d Bytes (%3d kB)\n", uz, uz/1024);
	while (uz > 0) {
		int l, n;
	...
	fprintf (stderr, "Disk Image %7d Bytes (%3d kB)\n", (int)(512 + sys_size + usr_size), (int)(512 + sys_size + usr_size)/1024);
	buf[0] = (im_size & 0xff);
